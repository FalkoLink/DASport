...
$products = $db -> prepare('SELECT * FROM `products` WHERE `categories_id` = ?');
$products -> bindParam(1, $_REQUEST["c"],  PDO::PARAM_INT);
$products ->execute();
...
<body>
	<header>
		...
		<div class="form">
			...
			?>
			<div class="profile">
				<div class="pro_photo" class="myphoto" id="myphoto" onclick="myPhoto">
					<img src="./users_picture/<?= $user['avatar']?>" alt="prof" width="30" height="30">
						...
						<div class="post">
							...
							<div class="content">
								...
								<?php if($signin == 'not_entered'):?>
                                    ./join/signin.php
                                <?php else:?>
                                    ./show.php?id=<?= $search_sel['id']?>&back=i
                                <?php endif;?>
								">View</a>
							</div>
						</div>
				...
				<div class="post">
					...
					<div class="content">
						...
						<?php if($signin == 'not_entered'):?>
                            ./join/signin.php
                        <?php else:?>
                            ./show.php?id=<?= $product['id']?>&back=p&c=<?= $_REQUEST['c']?>
                        <?php endif;?>
						">View</a>
					</div>
				</div>
